...
ActiveRecord::Schema.define(version: 2021_11_23_180815) do
  ...
  create_table "shopping_cart_items", force: :cascade do |t|
    ...
    t.index ["shopping_cart_id", "product_id"], name: "index_shopping_cart_items_on_shopping_cart_id_and_product_id", unique: true
